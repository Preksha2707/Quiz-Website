<!DOCTYPE<html>
    ...
    <body>
        ...
        <div class="outer-div">
             ...
             {
                echo "<font color='green'>Course Added!</font>";
             }
             else if(isset($_GET['msg'])=="Error")
             {
                echo "<font color='red'>Course Not Added!</font>";
             }
            echo "<form method='GET' action='add_course_helper.php' style='background-color:#fff;width:300px;align-items: center;padding:50px 200px 50px 70px;'>";
